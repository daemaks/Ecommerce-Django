...
class Category(MPTTModel):
    ...
    slug = models.SlugField(
        verbose_name=("Category safe URL"), max_length=120, unique=True
    )
    ...
    def get_absolute_url(self):
        return reverse("catalog:category_list_url", args=[self.slug])
...
class ProductSpecification(models.Model):
    ...
    name = models.CharField(
        verbose_name=_("Name"), help_text=_("Required"), max_length=120
    )
...
class Product(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("catalog:product_details_url", args=[self.slug])
